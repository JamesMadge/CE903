...
class Worker:
    def __init__(self, game, name, s_size, a_size, trainer, model_path, global_episodes):
        ...
        # TODO Each worker: Select random track, select random car.
        # TODO Screen: Resolution, colour? Capture screens.
        # TODO Features: Render game features? Mini-map, speedometer? Camera-angle?
        # TODO Looping: How and when to timeout? How to restart (when off track, when going backwards etc.)?
        # TODO Rewards: How given?
        # TODO Interact: Do action (steering/speed).

        # TODO Interface:
        # Constructor.
        # env.new_episode()
        # env.get_state().screen_buffer
        # env.is_episode_finished()
        # env.make_action(self.actions[a]) / 100.0
